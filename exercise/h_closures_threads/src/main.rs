...
fn main() {
    ...
    // calls so that both the "Thread A" outputs occur before the "Thread B" outputs.
    ...
    pause_ms(1000); // Make sure Thread A has time to get going before we spawn Thread B
